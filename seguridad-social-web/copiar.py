...
if __name__ == "__main__":
    # Ejemplo de uso
    source_dirs = [
        "/home/juanjo/TFG_USECASES_VC/seguridad-social-web/frontend"
    ]
    exclude_dirs = ["node_modules", "build", "dist", "data",".git", "waltid-identity","coverage","test-results",".nuxt",".output"]
