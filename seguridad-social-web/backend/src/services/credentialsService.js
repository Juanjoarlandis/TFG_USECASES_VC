...
async function getCredentialById(credentialId) {
    try {
        ...
        logger.error('[credentialsService] Error getting credential by ID:', error.message);
        throw error;
    }
}
...
async function deleteCredential(credentialId) {
    try {
        ...
        logger.info(`[credentialsService] Credential ${credentialId} deleted successfully`);
    } catch (error) {
        logger.error('[credentialsService] Error deleting credential:', error.message);
        throw error;
    }
}
...
async function acceptCredential(credentialId) {
    try {
        ...
        logger.error('[credentialsService] Error accepting credential:', error.message);
        throw error;
    }
}
...
async function rejectCredential(credentialId) {
    try {
        ...
        logger.error('[credentialsService] Error rejecting credential:', error.message);
        throw error;
    }
}
...
async function getCredentialStatus(credentialId) {
    try {
        ...
        logger.error('[credentialsService] Error getting credential status:', error.message);
        throw error;
    }
}
