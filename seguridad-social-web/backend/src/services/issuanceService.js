...
module.exports = {
    ...
    async offerIssuance(stateId) {
        ...
        logger.debug(`[offerIssuance] => issueResponse.data: ${JSON.stringify(issueResponse.data, null, 2)}`);
    ...
    async claimAltaCredential(stateId) {
        ...
        logger.debug(`[claimAltaCredential] => Resp.data: ${JSON.stringify(resp.data, null, 2)}`);
